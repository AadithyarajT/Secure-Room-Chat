...
from .models import UserEncryptionKey, RoomUserKey, RoomEncryptionKey
...
@admin.register(RoomUserKey)
class RoomUserKeyAdmin(admin.ModelAdmin):
...
@admin.register(RoomEncryptionKey)
class RoomEncryptionKeyAdmin(admin.ModelAdmin):
